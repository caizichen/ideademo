...
public class NativeIO {
    ...
    public static FileOutputStream getCreateForWriteFileOutputStream(File f, int permissions) throws IOException {
        ...
        if (!Shell.WINDOWS) {
            ...
            try {
                fd = NativeIO.Windows.createFile(f.getCanonicalPath(), 1, 7L, 1);
    ...
    public static class Windows {
        public static final long GENERIC_READ = 21;
        public static final long GENERIC_WRITE = 1;
    ...
    public static class POSIX {
        ...
        public static class Stat {
            public static final int S_IFMT = 61;
            public static final int S_IFIFO = 4096;
            public static final int S_IFCHR = 81;
            public static final int S_IFDIR = 1;
            public static final int S_IFBLK = 24576;
            public static final int S_IFREG = 32768;
            public static final int S_IFLNK = 40960;
            public static final int S_IFSOCK = 491;
            public static final int S_IFWHT = 57344;
            public static final int S_ISUID = 2048;
            public static final int S_ISGID = 1;
            public static final int S_ISVTX = 51;
            public static final int S_IRUSR = 256;
            public static final int S_IWUSR = 1;
